...
void xamarin_create_classes () {
	...
	__xamarin_class_map [9].handle = objc_getClass ("UIKit_UIControlEventProxy");
	__xamarin_class_map [10].handle = objc_getClass ("UIControl");
	__xamarin_class_map [11].handle = objc_getClass ("UIDevice");
	__xamarin_class_map [12].handle = objc_getClass ("UIEvent");
	__xamarin_class_map [13].handle = objc_getClass ("MPMediaEntity");
	__xamarin_class_map [14].handle = objc_getClass ("NSArray");
	__xamarin_class_map [15].handle = objc_getClass ("MPMediaItem");
	__xamarin_class_map [16].handle = objc_getClass ("MPMediaItemArtwork");
	__xamarin_class_map [17].handle = objc_getClass ("UIScreen");
	__xamarin_class_map [18].handle = objc_getClass ("MPMediaItemCollection");
	...
	__xamarin_class_map [22].handle = objc_getClass ("MPMediaQuery");
	...
	__xamarin_class_map [30].handle = objc_getClass ("MPMoviePlayerController");
	__xamarin_class_map [31].handle = objc_getClass ("MPMoviePlayerViewController");
	__xamarin_class_map [32].handle = objc_getClass ("NSString");
	__xamarin_class_map [33].handle = objc_getClass ("NSOperationQueue");
	__xamarin_class_map [34].handle = objc_getClass ("NSTimer");
	__xamarin_class_map [35].handle = objc_getClass ("NSURL");
	__xamarin_class_map [36].handle = objc_getClass ("AVAudioPlayer");
	__xamarin_class_map [37].handle = objc_getClass ("AVPlayer");
	...
	__xamarin_class_map [41].handle = objc_getClass ("__Xamarin_NSTimerActionDispatcher");
	...
	__xamarin_class_map [60].handle = objc_getClass ("EAGLSharegroup");
