...
@implementation OpenTK_Platform_iPhoneOS_iPhoneOSGameView { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_3 (self, _cmd, &managed_method, "OpenTK.Platform.iPhoneOS.iPhoneOSGameView, OpenTK-1.0", "LayoutSubviews");
	}
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [4].handle = objc_getClass ("AVAudioPlayer");
	...
	__xamarin_class_map [19].handle = objc_getClass ("CMLogItem");
	__xamarin_class_map [20].handle = objc_getClass ("CMAccelerometerData");
	__xamarin_class_map [21].handle = objc_getClass ("EAGLContext");
	__xamarin_class_map [22].handle = objc_getClass ("CKShareMetadata");
	__xamarin_class_map [23].handle = objc_getClass ("MPMediaEntity");
	__xamarin_class_map [24].handle = objc_getClass ("MPMediaItem");
	__xamarin_class_map [25].handle = objc_getClass ("MPMediaItemArtwork");
	__xamarin_class_map [26].handle = objc_getClass ("MPMediaQuery");
	__xamarin_class_map [27].handle = objc_getClass ("MPMoviePlayerController");
	...
	__xamarin_class_map [42].handle = objc_getClass ("CAEAGLLayer");
	__xamarin_class_map [43].handle = objc_getClass ("NSError");
	__xamarin_class_map [44].handle = objc_getClass ("UIApplicationShortcutItem");
	__xamarin_class_map [45].handle = objc_getClass ("CMMotionManager");
	__xamarin_class_map [46].handle = objc_getClass ("CMDeviceMotion");
	__xamarin_class_map [47].handle = objc_getClass ("MPMediaItemCollection");
	__xamarin_class_map [48].handle = objc_getClass ("NSEnumerator");
	__xamarin_class_map [49].handle = objc_getClass ("NSException");
	__xamarin_class_map [50].handle = objc_getClass ("MPMoviePlayerViewController");
	...
	__xamarin_class_map [55].handle = objc_getClass ("UIFocusUpdateContext");
	__xamarin_class_map [56].handle = objc_getClass ("UILocalNotification");
	__xamarin_class_map [57].handle = objc_getClass ("EAGLSharegroup");
	__xamarin_class_map [58].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [59].handle = objc_getClass ("UITextRange");
	__xamarin_class_map [60].handle = objc_getClass ("UITextSelectionRect");
	__xamarin_class_map [61].handle = objc_getClass ("UITouch");
	__xamarin_class_map [62].handle = objc_getClass ("UIUserNotificationSettings");
	__xamarin_class_map [63].handle = objc_getClass ("UIWindow");
	__xamarin_class_map [64].handle = objc_getClass ("AVAudioSession");
	...
	__xamarin_class_map [68].handle = objc_getClass ("NSMutableDictionary");
	__xamarin_class_map [69].handle = objc_getClass ("NSNotificationCenter");
	__xamarin_class_map [70].handle = objc_getClass ("NSSet");
	__xamarin_class_map [71].handle = objc_getClass ("UIAlertView");
	__xamarin_class_map [72].handle = objc_getClass ("AVPlayerItem");
	__xamarin_class_map [73].handle = [AppDelegate class];
	__xamarin_class_map [74].handle = [Microsoft_Xna_Framework_iOSGameViewController class];
	__xamarin_class_map [75].handle = [iOSGameView class];
